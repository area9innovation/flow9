...
function getAppConfigEnv(envName) {
	return window.__APP_CONFIG__ && window.__APP_CONFIG__[envName];
}
...
sendXMLHttpRequest("GET", "php/env.php", function (responseText) {
	window.__APP_CONFIG__ = { salt: responseText.trim() };
});
