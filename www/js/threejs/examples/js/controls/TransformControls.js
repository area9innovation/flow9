...
THREE.TransformControls = function ( camera, domElement, eventElement ) {
	...
	if ( eventElement === undefined ) {
		...
		console.warn( 'THREE.TransformControls: The third parameter "eventElement" is now mandatory.' );
	...
	function getPointer( event ) {
		...
		return {
			x: pointer.pageX / domElement.width * 2 - 1,
			y: - pointer.pageY / domElement.height * 2 + 1,
			button: event.button
		};
