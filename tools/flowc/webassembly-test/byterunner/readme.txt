to compile wasm byterunner:
	...
	- check flow/tools/flowc/webassembly-test/byterunner/compile.bat for correct paths and execute it

test files located in flow/tools/flowc/webassembly-test/byterunner/tests. to compile tests into bytecode use compile_flow.bat or compile_flowc.bat
result will be saved in flow/tools/flowc/webassembly-test/byterunner/out
