...
for /f %%x in ('wmic os get localdatetime ^| find "."') do set CurrDate=%%x
set NOW=%CurrDate:~0,4%-%CurrDate:~4,2%-%CurrDate:~6,2% %CurrDate:~8,2%:%CurrDate:~10,2%:%CurrDate:~12,2%
...
echo 	flowc_build_time = "%NOW%";>> %VERFILE%
echo }>> %VERFILE%
)
