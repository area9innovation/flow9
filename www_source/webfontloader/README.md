...
##HOW TO BUILD
Install ruby and then run rake. it will build
In order to build non-gemified file, remove Gemfile, change Rakefile --compilation_level into SIMPLE and build
