...
function changeThirdPersonCameraLimits(id, limits) {
	rayCanvasManager.get(id.toString()).changeThirdPersonCameraLimits({lower: limits.first, upper : limits.second})
}

function changeFirstPersonCameraLimits(id, limits) {
	rayCanvasManager.get(id.toString()).changeFirstPersonCameraLimits({lower: limits.first, upper : limits.second})
}