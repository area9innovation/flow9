...
function updateMeshParameters(id, positions, rotations, scales, colors) {
	rayCanvasManager.get(id.toString()).updateMeshParameters(positions, rotations, scales, colors)
}