...
function doRecompileShader(state, fragCode) {
	...
	state.uboMaterialsInfo = calculateMaterialsUBOInfo(state, ["color[0]", "reflectiveness[0]"]);
...
function rayMain(id) {
	...
	state.uboMaterialsInfo = calculateMaterialsUBOInfo(state, ["color[0]", "reflectiveness[0]", "objectParameters[0]", "smoothCoefficients[0]"]);
...
function calculateMaterialsUBOInfo(state, uboVariableNames) {
	let gl = state.gl;
