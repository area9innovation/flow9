...
class AccessWidgetTree extends EventEmitter {
	...
	public function updateDisplay() : Void {
		if (RenderSupport.RendererType != "html" || (accessWidget != null && accessWidget.clip != null && !accessWidget.clip.isHTMLRenderer())) {
			updateTransform();
...
class AccessWidget extends EventEmitter {
	...
	public function set_element(element : Element) : Element {
		if (this.element != element) {
			if (this.element != null && this.element.parentNode != null && (element != null || RenderSupport.RendererType != "html" || (this.clip != null && !this.clip.isHTMLRenderer()))) {
	...
	public function set_role(role : String) : String {
		...
		if (this.clip.isHTMLRenderer() && accessRoleMap.get(role) != null &&
